...
class Matern_Product(object):
    ...
    def __init__(self, nu = 2.01, lengthscale = 1e-1, pde_operator=None, **kwargs):
        ...
        if (pde_operator is None): pde_operator=0
        self.nu = nu
    ...
    def LK(self, x1, x2 = None, pde_operator=None, theta = None):  # change here when operator changes: LK
        ...
        if (pde_operator==0):
            if x1.shape[0] == 0 or x2.shape[0] == 0 : return (torch.zeros(0))
            with torch.no_grad():
                comp_1=self.dC_dx_L_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_2=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Ldx_L_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_3=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Ldx_L_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_4=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Ldx_L_comp(x1[:,3], x2[:,3], ind=3)
                LK_all = torch.cat((comp_2+comp_3+comp_4,comp_1),0)
            return(comp_2+comp_3+comp_4, comp_1, LK_all)
    ...
    def KL(self, x1, x2 = None, pde_operator=None,theta = None): # change here when operator changes: KL
        ...
        if (pde_operator==0):
            if x1.shape[0] == 0 or x2.shape[0] == 0 : return (torch.zeros(0))
            with torch.no_grad():
                comp_1=self.dC_dx_R_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_2=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Rdx_R_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_3=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Rdx_R_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_4=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Rdx_R_comp(x1[:,3], x2[:,3], ind=3)
                KL_all = torch.cat((comp_2+comp_3+comp_4,comp_1),1)
            return(comp_2+comp_3+comp_4, comp_1,KL_all)
    ...
    def LKL(self, x1, x2 = None, pde_operator=None, theta = None): 
        ...
        if (pde_operator==0): 
            if x1.shape[0] == 0 or x2.shape[0] == 0 : return (torch.zeros(0))
            with torch.no_grad():
                comp_11=self.d2C_dx_Ldx_R_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_12=self.dC_dx_L_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Rdx_R_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_13=self.dC_dx_L_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Rdx_R_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_14=self.dC_dx_L_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Rdx_R_comp(x1[:,3], x2[:,3], ind=3)
                comp_21=self.dC_dx_R_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Ldx_L_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_22=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d4C_dx_Ldx_Ldx_Rdx_R_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_23=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Ldx_L_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Rdx_R_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_24=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Ldx_L_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Rdx_R_comp(x1[:,3], x2[:,3], ind=3)
                comp_31=self.dC_dx_R_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Ldx_L_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_32=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Rdx_R_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Ldx_L_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_33=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d4C_dx_Ldx_Ldx_Rdx_R_comp(x1[:,2], x2[:,2], ind=2)*self.corr_comp(x1[:,3], x2[:,3], ind=3)
                comp_34=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Ldx_L_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Rdx_R_comp(x1[:,3], x2[:,3], ind=3)
                comp_41=self.dC_dx_R_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Ldx_L_comp(x1[:,3], x2[:,3], ind=3)
                comp_42=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.d2C_dx_Rdx_R_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Ldx_L_comp(x1[:,3], x2[:,3], ind=3)
                comp_43=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.d2C_dx_Rdx_R_comp(x1[:,2], x2[:,2], ind=2)*self.d2C_dx_Ldx_L_comp(x1[:,3], x2[:,3], ind=3)
                comp_44=self.corr_comp(x1[:,0], x2[:,0], ind=0)*self.corr_comp(x1[:,1], x2[:,1], ind=1)*self.corr_comp(x1[:,2], x2[:,2], ind=2)*self.d4C_dx_Ldx_Ldx_Rdx_R_comp(x1[:,3], x2[:,3], ind=3)
                LKL_all = torch.cat((torch.cat((comp_22+comp_23+comp_24+comp_32+comp_33+comp_34+comp_42+comp_43+comp_44,comp_21+comp_31+comp_41),1),torch.cat((comp_12+comp_13+comp_14,comp_11),1)),0)
            return(comp_22+comp_23+comp_24+comp_32+comp_33+comp_34+comp_42+comp_43+comp_44, comp_11, comp_21+comp_31+comp_41, comp_12+comp_13+comp_14,LKL_all)      
...
class GP_modeling(object):
    ...
    def Train_GP(self, PDEmodel, train_x = None, train_y = None, noisy = True, max_iter = 500, verbose = False, eps=1e-6, ind_y = 0):
        ...
        print('Time for training GP:',np.int64(time_GP_end-time_GP_start), ' secs')
